      ...
      <b-card class="mb-4" :title="$t('forms.top-labels-over-line')">
        ...
        >
          <b-form-group :label="$t('forms.email')" class="has-float-label">
            ...
            <b-form-invalid-feedback v-else-if="!$v.overLineForm.email.email">Invalid email address
          ...
          <b-form-group :label="$t('forms.password')" class="has-float-label">
            ...
            />
            <b-form-invalid-feedback v-if="!$v.overLineForm.password.required">Password is required!
            </b-form-invalid-feedback>
            <b-form-invalid-feedback v-else-if="!$v.overLineForm.password.minLength">Minimum 6</b-form-invalid-feedback>
            <b-form-invalid-feedback v-else-if="!$v.overLineForm.password.maxLength">Maximum 16
            </b-form-invalid-feedback>
          </b-form-group>
      ...
      <b-card class="mb-4" :title="$t('forms.top-labels-over-line')">
        ...
        >
          <b-form-group :label="$t('forms.email')" class="has-top-label">
            ...
            />
            <b-form-invalid-feedback v-if="!$v.labelsInInput.email.required">Email is required!
            </b-form-invalid-feedback>
            <b-form-invalid-feedback v-else-if="!$v.labelsInInput.email.email">Invalid email address
            </b-form-invalid-feedback>
          </b-form-group>
          <b-form-group :label="$t('forms.password')" class="has-top-label">
            ...
            <b-form-invalid-feedback v-else-if="!$v.labelsInInput.password.minLength">Minimum 6
            </b-form-invalid-feedback>
            <b-form-invalid-feedback v-else-if="!$v.labelsInInput.password.maxLength">Maximum 16
            </b-form-invalid-feedback>
          </b-form-group>
