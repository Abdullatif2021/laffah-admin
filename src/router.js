...
const routes = [{
  path: "/",
  component: () =>
    import ( /* webpackChunkName: "home" */ "./views/app"),
  redirect: `${adminRoot}/dashboards/default`,
  meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin, UserRole.casher]},
    ...
    */
    children: [{
    ...
    },
      {
        path: "blocks",
        component: () =>
          import ( /* webpackChunkName: "dashboards" */ "./views/app/blocks/index"),
        ...
        children: [{
          ...
          children: [{
            path: "form",
            component: () =>
              import ( /* webpackChunkName : ":slug" */ "./views/app/blocks/form"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin]},
          },
            {
              path: "list",
              component: () =>
                import ( /* webpackChunkName : ":slug" */ "./views/app/blocks/list"),
              meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
        ...
        },
          {
            ...
            children: [{
              ...
              component: () =>
                import ( /* webpackChunkName : "events" */ "./views/app/blocks/attachments/attachment-form")
            },
              {
                path: "attachment-list/:id",
                component: () =>
                  import ( /* webpackChunkName : "events" */ "./views/app/blocks/attachments/attachment-list"),
                meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
      ...
      // },
      {
        path: "items",
        component: () =>
          import ( /* webpackChunkName: "dashboards" */ "./views/app/items/index"),
        ...
        children: [{
          ...
          // },
          {
            path: "items-list",
            component: () =>
              import ( /* webpackChunkName: "dashboards" */ "./views/app/items/items-list"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
          },
          {
            path: "attributes",
            ...
            children: [{
              path: "attribute-form",
              component: () =>
                import ( /* webpackChunkName: "dashboards" */ "./views/app/items/attributes/attribute-form"),
              meta: {loginRequired: true, roles: [UserRole.superadmin]},
            },
              {
                path: "attribute-list",
                component: () =>
                  import ( /* webpackChunkName: "dashboards" */ "./views/app/items/attributes/attribute-list"),
                meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
              },
              {
          ...
          },
          {
            ...
            children: [{
            ...
            },
              {
                ...
                component: () =>
                  import ( /* webpackChunkName: "dashboards" */ "./views/app/items/attribute-group/attribute-group-list"),
                meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
              },
              {
          ...
          //  },
          {
            path: "customizations",
            component: () =>
              import ( /* webpackChunkName: "dashboards" */ "./views/app/items/customizations"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin]},
          ...
          },
          {
            ...
            children: [{
              ...
              component: () =>
                import ( /* webpackChunkName: "dashboards" */ "./views/app/items/categories/form"),
              meta: {loginRequired: true, roles: [UserRole.superadmin]},
            },
              {
                path: "list",
                component: () =>
                  import ( /* webpackChunkName: "dashboards" */ "./views/app/items/categories/list"),
                meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
              }, {
      ...
      },
      {
        path: "branches",
        component: () =>
          import ( /* webpackChunkName: "branches" */ "./views/app/branches/index"),
        ...
        children: [{
          path: "branches-form",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/branches/branches-form"),
          meta: {loginRequired: true, roles: [UserRole.superadmin]},
        ...
        },
          {
            path: "branches-list",
            component: () =>
              import ( /* webpackChunkName : "product" */ "./views/app/branches/branches-list"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
      ...
      },
      {
        ...
        children: [{
          path: "users-form",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/users/users-form"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
        ...
        },
          {
            path: "list",
            component: () =>
              import ( /* webpackChunkName : "product" */ "./views/app/users/list"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
          },
          {
            path: "users-form/:id",
      ...
      },
      {
        ...
        children: [{
          path: "list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/orders/list"),
          meta: {
            loginRequired: true,
            roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin, UserRole.casher]
          },
        ...
        },
          {
            path: "details/:id",
            component: () =>
              import ( /* webpackChunkName: "branches" */ "./views/app/orders/details"),
            meta: {
              loginRequired: true,
              roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin, UserRole.casher]
            },
      ...
      },
      {
        path: "careers",
        component: () =>
          import ( /* webpackChunkName: "branches" */ "./views/app/careers/index"),
        ...
        children: [{
          path: "careers-list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/careers/careers-list"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},

        }, {
          path: "careers-form",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/careers/careers-form"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
          ...
          },
          {
            path: "applicants",
            component: () =>
              import ( /* webpackChunkName: "branches" */ "./views/app/careers/applicants/applicants-list"),
            // redirect: `${adminRoot}/careers/careers-list`,
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
            ...
            children: [{
              ...
              component: () =>
                import ( /* webpackChunkName : "product" */ "./views/app/careers/applicants/applicants-list"),
              meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
...

      {
        ...
        children: [{
          path: "pages-list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/page/pages-list"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
        ...
        },
          {
            path: "pages-form/:id",
            component: () =>
              import ( /* webpackChunkName : "product" */ "./views/app/page/pages-form"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
          },
        ]
      },

      {
        ...
        children: [{
          path: "list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/areas/areas-list"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
        ...
        },
          {
            path: "list/:slug/:id",
            component: () =>
              import ( /* webpackChunkName : ":slug/:id" */ "./views/app/areas/areas-list"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
      ...
      },
      {
        ...
        children: [{
          ...
          },
          {
            path: "all-orders",
            component: () =>
              import ( /* webpackChunkName: "branches" */ "./views/app/all-orders/index"),
            ...
            children: [{
              path: "list",
              component: () =>
                import ( /* webpackChunkName : "product" */ "./views/app/all-orders/list"),
              meta: {
                loginRequired: true,
                roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin, UserRole.casher]
              },
      ...
      },
      {
        path: "notifications",
        component: () =>
          import ( /* webpackChunkName: "notifications" */ "./views/app/notifications/index"),
        redirect: `${adminRoot}/notifications/list`,
        meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
        children: [{
          path: "list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/notifications/list"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
      ...
      },
      {
        path: "reports",
        component: () =>
          import ( /* webpackChunkName: "notifications" */ "./views/app/reports/index"),
        ...
        children: [{
          path: "list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/reports/list"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
      ...
      },
      {
        ...
        children: [{
          path: "list",
          component: () =>
            import ( /* webpackChunkName : "product" */ "./views/app/seo/meta-list"),
          meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
        ...
        },
          {
            path: "list/:slug/:id",
            component: () =>
              import ( /* webpackChunkName : ":slug/:id" */ "./views/app/seo/meta-list"),
            meta: {loginRequired: true, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
  ...
  },
  {
    ...
    meta: {
      loginRequired: false,
      roles: [UserRole.superadmin, UserRole.admin, UserRole.user, UserRole.branchadmin, UserRole.guest]
    },
    ...
    children: [{
      ...
      },
      {
        ...
        meta: {loginRequired: false, roles: [UserRole.superadmin, UserRole.admin, UserRole.branchadmin]},
