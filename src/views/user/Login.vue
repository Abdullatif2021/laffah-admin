    ...
    <b-row class="h-100">
        <b-colxx
            ...
            <b-card
                class="auth-card"
                no-body>
                <div class="position-relative image-side d-flex flex-column-reverse">
                </div>
                <div class="form-side">
                    <router-link
                        tag="a"
                      ...
                      <h2>Laffah Restaurants Admin Panel</h2>
                    </router-link>
                    ...
                    <b-form
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <router-link
                                tag="a"
                                to="/user/forgot-password">{{ $t('user.forgot-password-question')}}</router-link>
                            <b-button
                                type="submit"
                                variant="primary"
                                size="lg"
