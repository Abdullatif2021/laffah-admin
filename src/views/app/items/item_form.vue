  ...
  <div>
        ...
        <b-colxx xxs="12">
          ...
          <div v-else class="top-right-button-container">
            ...
            <switches
              ...
              class="vue-switcher-small d-flex align-self-center top-right-button"
            ></switches>
          </div>
          <piaf-breadcrumb />
          <b-tabs
                      ...
                      <b-row style="margin: 42px">
                        ...
                        >
                          ...
                          >
                            ...
                            <img
                              :src="
                                mainImage ? imgUrl : $v.files_form.image.$model
                              "
                        ...
                        <b-colxx sm="6">
                          <b-form-group>
                            ...
                            <b-form-invalid-feedback
                              v-if="!$v.gridForm.category.required"
                        ...
                        <b-colxx sm="6">
                          <b-form-group>
                            ...
                            />
                            <b-form-invalid-feedback
                              v-if="!$v.gridForm.record_order.required"
                              >Please enter a record
                              order</b-form-invalid-feedback
                            >
                          </b-form-group>
                        </b-colxx>
                        <b-colxx xxs="6">
                          ...
                          <b-row>
                            <b-colxx sm="12">
                              <b-form-group>
                                ...
                                />
                                <b-form-invalid-feedback
                                  v-if="!$v.lang_form.en_name.required"
                      ...
                      <template slot="row-details">
                        <b-form-group>
                          <template v-if="checkboxOptions.length > 0">
                            <label class="form-group-label cate_class"
                              >Branches:
                            </label>
            ...
            <b-colxx sm="12">
              <b-form-group label="Branches" class="form-group-label">
                ...
                <b-form-select
                  ...
                  plain
                />
                <b-form-invalid-feedback v-if="!$v.batch_form.branch.required"
          ...
          <div class="branch_container" v-if="selectedBranch">
            <b-form-row>
              <colxx xxs="8">
                ...
                />
                <b-form-invalid-feedback v-if="!$v.batch_form.price.required"
                  >Please enter the price</b-form-invalid-feedback
                >
              </colxx>
              <colxx xxs="4">
                <b-from-group>
                  <switches
                    v-model="selectedBranch.active"
                    theme="custom"
                    color="primary"
                    class="vue-switcher-small switcher"
                  ></switches>
                </b-from-group>
              </colxx>
            </b-form-row>
    ...
    >
      ...
      <template slot="modal-footer">
        <b-button
          variant="outline-secondary"
          @click="hideModal('modalright_related')"
          >{{ $t("survey.cancel") }}</b-button
        >
        <b-button variant="primary" @click="submitBatchList()" class="mr-1">{{
          $t("survey.submit")
        }}</b-button>
      </template>
    </b-modal>
    ...
    <b-modal
      ...
      <template slot="modal-footer">
        <b-button
          ...
          >Yes</b-button
        >
        <b-button variant="secondary" @click="hideModal('deleteItem')"
          >No</b-button
        >
      </template>
    </b-modal>
    <b-modal :id="`delete_batch`" ref="delete_batch" size="sm" hide-header>
      ...
      <template slot="modal-footer">
        ...
        <b-button size="xs" variant="light" @click="hideModal('delete_batch')"
          >{{ $t("cancel") }}
        </b-button>
      </template>
    </b-modal>
...
export default {
  ...
  methods: {
    ...
    getAttrib(value) {
      ...
      let itm = value.map((x) =>
        x.attribute.locales.en.list_values.find(
          (y) => y.id === parseInt(x.value)
        )
      );
    ...
    loadAttributesList() {
      return Axios.get(
        `https://api-v2.laffahrestaurants.com/public/api/attributes`
      )
        .then((res) => {
          if (res.status === 200) {
    ...
    submitBatchList() {
      this.updateBatch({
        ...
        prices: this.selected_branches.map((x) => ({
          branch_id: x,
          price: this.main_price,
          active: true,
        })),
    ...
    loadBatchesList(id) {
      if (id) {
        return Axios.get(
          `https://api-v2.laffahrestaurants.com/public/api/items/batches/${id}`
        )
          .then((res) => {
            if (res.status === 200) {
    ...
    getBranches() {
      this.branchOptions = [];
      return Axios.get(
        `https://api-v2.laffahrestaurants.com/public/api/branches?type=dashboard`
      )
        .then((res) => {
          if (res.status === 200) {
  ...
  computed: {
    ...
    ...mapGetters([
      ...
      "_updateItem",
      "_deleteItem",
      "_updatedItemMainImageSuccessfuly",
      "create_item",
      "_batches",
      "create_Batch",
      "load_batches",
