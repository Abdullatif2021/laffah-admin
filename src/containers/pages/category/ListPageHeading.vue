    ...
    <b-colxx xxs="12">
      ...
      <div class="top-right-button-container">
        ...
        v-if="authorSuperadmin"
          ...
          to="create-category">{{ $t('pages.add-new') }}
        </b-button>

      </div>
      <add-new-modal
        :categories="selectData"
        :statuses="statuses"></add-new-modal>
      <piaf-breadcrumb />
      <div class="mb-2 mt-2">
        <b-button
          variant="empty"
...
import AddNewModal from "./AddNewCategory";
...
export default {
  ...
  methods: {
    resetCurrentCategory() {
      this.$store.commit('category/SET_CurrentCategory', null)
    }
  },
  watch: {
    selectData() {
      this.categories = this.selectData
    }
  },
};
</script>
