...
export default {
  ...
  loadCategoriesList() {
    return Axios
      .get(`https://api2.laffahrestaurants.com/api/categories`)
      .then(res =>{
        if (res.status === 200) {
  ...
  loadAttributesList() {
    return Axios
      .get(`https://api2.laffahrestaurants.com/api/attributes`)
      .then(res =>{
        if (res.status === 200) {
...
*/
  ...
  loadBatchesList(id) {
    if(id){
      return Axios
        .get(`https://api2.laffahrestaurants.com/api/items/batches/${id}`)
        .then(res =>{
          if (res.status === 200) {
...
getBranches(){
  this.branchOptions = [];
  return Axios
        .get(`https://api2.laffahrestaurants.com/api/branches?type=dashboard`)
        .then(res =>{
          if (res.status === 200) {
