          ...
          <template slot="actions" slot-scope="props">
            ...
            >
              ...
              <b-icon-trash
                ...
                v-b-modal="
                  `delete-${props.rowData.item_id}-${props.rowData.id}`
                "
                :batch-id="props.rowData.id"
                scale="1.5"
                class="ml-3"
            ...
            >
              ...
              <template slot="modal-footer">
                ...
                <b-button variant="light" @click="hideModal('modallg')"
                  >Cancel
                </b-button>
              </template>
            </b-modal>
...
export default {
  ...
  data() {
    return {
      ...
      httpOptions: {
        headers: {
          Authorization: decrypt(localStorage.getItem("accessToken")),
        },
      },
  ...
  methods: {
    onLoading() {
      // this.isLoading = true
      this.noDataString =
        '<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="circle fill" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-circle-fill b-icon bi text-primary b-icon-animation-throb" style="font-size: 300%;"><g><circle cx="8" cy="8" r="8"></circle></g></svg>';
    ...
    calculatePagination() {
      ...
      this.lastPage =
        this.total > this.perPage ? Math.ceil(this.total / this.perPage) : 1;
      this.$emit;
    },
