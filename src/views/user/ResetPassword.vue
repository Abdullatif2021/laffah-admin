<template>
  <b-row class="h-100">
    <b-colxx
      ...
      <b-card
        class="auth-card d-flex align-items-center"
        no-body>
        ...
        <div class="form-side col-md-6">
          ...
          <b-form
            ...
            <b-form-group
              ...
              <b-form-invalid-feedback v-if="!$v.form.passwordAgain.required">Please enter your password again
              </b-form-invalid-feedback>
              <b-form-invalid-feedback v-else-if="!$v.form.passwordAgain.sameAsPassword">Your inputs does not match
              </b-form-invalid-feedback>
            </b-form-group>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <router-link
                tag="a"
                to="/user/login">{{ $t('user.login-button') }}
              </router-link>
              <b-button
                type="submit"
                variant="primary"
  ...
  methods: {
    ...
    formSubmit() {
      ...
      if (!this.$v.form.$anyError) {
        ...
        this.formData.append("token", this.$route.params.slug);
        this.formData.append("email", this.form.email);
        this.formData.append("password", this.form.password);
        this.formData.append("password_confirmation", this.form.passwordAgain);
