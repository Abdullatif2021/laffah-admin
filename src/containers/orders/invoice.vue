  ...
  <section :ref="`invoice-${order.id}`" :id="`invoice-${order.id}`">
    <div class="invoice-box">
      <table cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="left" class="title">
                  <img
                    ...
                    style="width: 70px; max-width: 150px"
                    width="70"
                  />
          ...
          <td colspan="2" align="left">
            <table width="100%">
              <tr>
                ...
                <td dir="rtl" align="right">العدد</td>
              </tr>
            </table>
          </td>
        ...
        <tr class="item" v-for="item in products">
          ...
          <td align="right">
            <big>{{
              ((((item || {}).item || {}).locales || {})["ar"] || {}).name || ""
            }}</big
            ><br />
            <small
              v-if="
                Array.isArray(item.order_details_customization) &&
                !$_.isEmpty(item.order_details_customization)
              "
              v-for="custom in item.order_details_customization"
            >
              {{
                (
                  (((custom || {}).customization || {}).locales || {})["ar"] ||
                  {}
                ).title || "-"
              }}<br />
            </small>
        ...
        <tr class="total">
          <td align="left">{{ (order || {}).subtotal }}</td>

          <td dir="rtl" align="center">المجموع الفرعي :</td>
          <td></td>
        </tr>
        ...
        <tr
          ...
          class="total"
        >
          <td align="left">{{ (order || {}).discount_value }}</td>

          <td dir="rtl" align="center">الخصم :</td>
          <td></td>
        </tr>
...
<html>
  ...
  mounted() {
    axios
      .get("branches/" + this.order.branch_id)
